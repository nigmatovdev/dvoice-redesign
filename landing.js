/* ============================================================
   Sales — landing page · i18n dictionary + UI logic
   Languages: uz (default) · en
   ============================================================ */
...
const I18N = {
  ...
  hero_title:       { uz: "Har bir sotuv qo‘ng‘irog‘ini ballga aylantiring.",
                      en: "Turn every sales call into a score." },
  hero_sub:         { uz: "Sales barcha qo‘ng‘iroqlarni tinglaydi, ularni 0–100 ball bilan baholaydi va bitimlar qayerda yo‘qolayotganini hamda qaysi menejerga coaching kerakligini avtomatik ko‘rsatadi.",
  ...
  // ---- trust ----
  trust_label:      { uz: "O‘zbekistondagi sotuv jamoalari ishonadi",
                      en: "Trusted by sales teams across Uzbekistan" },

  // ---- features ----
  feat_eyebrow:     { uz: "IMKONIYATLAR",  en: "CAPABILITIES" },
  feat_h2:          { uz: "Qo‘ng‘iroqlarni tinglashning o‘rniga — natijani o‘qing.",
                      en: "Stop listening to calls. Start reading the outcome." },
  feat_lede:        { uz: "Sales — qo‘ng‘iroq markazingiz uchun nutq tahlili platformasi. Transkripsiya, ballash, coaching va pipeline — bitta tizimda.",
  ...
  f1_d: { uz: "AI har bir qo‘ng‘iroqni sizning sotuv skriptingiz bo‘yicha 0–100 ball bilan baholaydi — qo‘lda tinglashsiz.",
  ...
  f2_d: { uz: "40–60 ballik “oraliq” qo‘ng‘iroqlarni topadi — aynan shu yerda kichik coaching katta natija beradi.",
  ...
  f3_d: { uz: "Bosqichdan bosqichga o‘tish darajasini ko‘rsatadi va bitimlar aynan qayerda to‘kilayotganini belgilaydi.",
  ...
  f4_d: { uz: "Har bir menejerni sotuv qadamlari bo‘yicha baholaydi — kim salomlashishda, kim e’tirozda kuchsiz.",
  ...
  f5_d: { uz: "Eng tez-tez uchraydigan e’tirozlarni va ularning yopilishga ta’sirini avtomatik ajratadi.",
  ...
  f6_d: { uz: "Qo‘ng‘iroqlar, bosqichlar va bitimlar amoCRM bilan real vaqtda sinxronlanadi — qo‘shimcha ish yo‘q.",
  ...
  s1_d: { uz: "amoCRM va telefoniyangizni bir necha daqiqada ulang. Tarixiy qo‘ng‘iroqlar avtomatik yuklanadi.",
  ...
  s2_d: { uz: "AI har bir qo‘ng‘iroqni transkripsiya qiladi, skript bo‘yicha ballaydi va zaif nuqtalarni belgilaydi.",
          en: "AI transcribes every call, scores it against your script and flags the weak points." },
  s3_t: { uz: "O‘sing", en: "You grow" },
  s3_d: { uz: "Bitta ekranda coaching zonasini, pipeline’ni va menejerlar reytingini ko‘rib, konversiyani oshiring.",
  ...
  sc_lede:     { uz: "Operatsion panel sifat, ko‘nikma va pipeline holatini bir joyda jamlaydi. Aynan shu interfeysni siz uchun moslab beramiz.",
  ...
  r2_l: { uz: "kunlik QA — qo‘lda tinglashdan avtomatik hisobotgacha", en: "daily QA — from manual listening to an automatic report" },
  r3_n: { uz: "+18%", en: "+18%" },
  ...
  in_lede:     { uz: "amoCRM’dan boshlab telefoniya va xabar almashish kanallarigacha — Sales mavjud jarayoningizga ulanadi.",
  ...
  pr_lede:     { uz: "Barcha tariflar 14 kunlik bepul sinov bilan. Istalgan vaqtda bekor qiling.",
  ...
  q1: { uz: "Avval kuniga 10 ta qo‘ng‘iroq tinglardik. Endi 100% tahlil qilinadi — coaching zonasi to‘g‘ridan-to‘g‘ri ko‘rinadi.",
  ...
  q2: { uz: "Heatmap’dan keyin har bir menejer bilan nimaning ustida ishlashni aniq bilamiz. Konversiya ikki oyda sezilarli o‘sdi.",
  ...
  q3: { uz: "amoCRM bilan ulash 15 daqiqa oldi. Ertasiga birinchi hisobot tayyor edi — hech qanday qo‘shimcha jadval yo‘q.",
  ...
  faq1_a: { uz: "Sales o‘zbek va rus tillaridagi qo‘ng‘iroqlarni transkripsiya qiladi va tahlil qiladi, shu jumladan aralash nutqni ham.",
  ...
  faq2_a: { uz: "Siz o‘z sotuv skriptingiz va bosqichlaringizni belgilaysiz. AI har bir qo‘ng‘iroqni shu qadamlarga muvofiqligi bo‘yicha 0–100 ball bilan baholaydi.",
  ...
  faq3_a: { uz: "amoCRM to‘liq qo‘llab-quvvatlanadi. Boshqa tizimlar uchun ochiq API va webhook’lar mavjud — Biznes tarifida moslashtiramiz.",
  ...
  faq4_a: { uz: "Barcha yozuvlar shifrlangan holda saqlanadi va faqat sizning jamoangizga ko‘rinadi. Ma’lumotlaringiz hech qachon uchinchi tomonga sotilmaydi.",
  ...
  faq5_a: { uz: "Odatda 15 daqiqa. amoCRM va telefoniyani ulaganingizdan so‘ng birinchi tahlil 24 soat ichida tayyor bo‘ladi.",
  ...
  faq6_a: { uz: "14 kun davomida barcha PRO imkoniyatlaridan karta talab qilinmasdan foydalanasiz. Yoqmasa — hech narsa to‘lamaysiz.",
  ...
  cta_h2:      { uz: "Birinchi 100 ta qo‘ng‘irog‘ingizni bepul ballang.",
                 en: "Score your first 100 calls free." },
  cta_lede:    { uz: "Emailingizni qoldiring — biz hisob ochib, amoCRM ulashda yordam beramiz.",
  ...
  // ---- footer ----
  ft_blurb: { uz: "Qo‘ng‘iroq markazlari uchun AI nutq tahlili. Har bir qo‘ng‘iroq — ball, har bir ball — o‘sish imkoniyati.",
  ...
  ft_cr:      { uz: "© 2026 Sales — Speech analytics. Toshkent, O‘zbekiston.",
                en: "© 2026 Sales — Speech analytics. Tashkent, Uzbekistan." },
};

/* ---- apply language ---------------------------------------- */
function applyLang(lang) {
  document.documentElement.setAttribute('lang', lang === 'uz' ? 'uz' : 'en');
  document.querySelectorAll('[data-i18n]').forEach((el) => {
    const k = el.getAttribute('data-i18n');
    if (I18N[k] && I18N[k][lang] != null) el.textContent = I18N[k][lang];
  });
  document.querySelectorAll('[data-i18n-ph]').forEach((el) => {
    const k = el.getAttribute('data-i18n-ph');
    if (I18N[k] && I18N[k][lang] != null) el.setAttribute('placeholder', I18N[k][lang]);
  });
  document.querySelectorAll('[data-i18n-alt]').forEach((el) => {
    const k = el.getAttribute('data-i18n-alt');
    if (I18N[k] && I18N[k][lang] != null) el.setAttribute('alt', I18N[k][lang]);
  });
  document.querySelectorAll('.lang-seg button').forEach((b) =>
    b.classList.toggle('active', b.dataset.lang === lang));
  try { localStorage.setItem('sales-landing-lang', lang); } catch (e) {}
}
...
function applyTheme(theme) {
  ...
  try { localStorage.setItem('sales-landing-theme', theme); } catch (e) {}
}

/* ---- boot -------------------------------------------------- */
(function boot() {
  let lang = 'uz', theme = 'dark';
  try { lang = localStorage.getItem('sales-landing-lang') || 'uz'; } catch (e) {}
  try { theme = localStorage.getItem('sales-landing-theme') || 'dark'; } catch (e) {}
  ...
  function init() {
    ...
    // animate histogram bars when in view
    const hist = document.querySelector('.bars');
    if (hist) {
      const ho = new IntersectionObserver((entries) => {
        entries.forEach((e) => {
          if (e.isIntersecting) {
            hist.querySelectorAll('.bar').forEach((bar) => { bar.style.height = bar.dataset.h + '%'; });
            ho.disconnect();
          }
        });
      }, { threshold: 0.4 });
    ...
    // signup -> just focus feedback (no backend)
    document.querySelectorAll('form[data-signup]').forEach((f) => {
      f.addEventListener('submit', (ev) => {
        ev.preventDefault();
        const btn = f.querySelector('button');
        const orig = btn.textContent;
        btn.textContent = '✓';
        setTimeout(() => { btn.textContent = orig; f.reset(); }, 1600);
      });
    });
  }
